...
class MyClassifier(nn.Module):
    def __init__(self, hidden_layer):
        ...
        self.fc1 = nn.Linear(44, hidden_layer)
...
net_result = 0
net_result = get_mse_net(transfer2source(mix_target_x), transfer2target(mix_dev_x), transfer2target(mix_test_x), mix_target_y, mix_dev_y, mix_test_y)
net_result = net_result + get_mse_net(transfer2source(male_target_x), transfer2target(male_dev_x), transfer2target(male_test_x), male_target_y, male_dev_y, male_test_y)
net_result = net_result + get_mse_net(transfer2source(female_target_x), transfer2target(female_dev_x), transfer2target(female_test_x), female_target_y, female_dev_y, female_test_y)
print(net_result/3)